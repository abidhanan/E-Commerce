...
@section('content')
    <div class="container py-4">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h4 class="fw-semibold mb-0">Edit Breathability</h4>
        </div>

        <div class="card shadow-sm border-0">
            <div class="card-body">
                <form action="{{ route('admin.breathabilities.update', $breathability->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control @error('level') is-invalid @enderror" id="level"
                            name="level" value="{{ old('level', $breathability->level) }}" required>
                    ...
                    <div class="mb-3">
                        ...
                        <input id="description" type="hidden" name="description"
                            value="{{ old('description', $breathability->description) }}">
