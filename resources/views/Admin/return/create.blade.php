...
@section('title', 'Create Return Step')
    ...
    <div class="container-fluid">
        ...
        <div class="card shadow-sm">
            <div class="card-header">
                <h5 class="mb-0">Create Return Step</h5>
            </div>

            <div class="card-body">
                <form action="{{ route('admin.return-steps.store') }}" method="POST">
                    @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="title" class="form-control" value="{{ old('title') }}"
                                placeholder="Example: Payment" required>
