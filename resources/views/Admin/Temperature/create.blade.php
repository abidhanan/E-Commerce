...
@section('title', 'Create Temperature')
    ...
    <div class="container mt-4">
        ...
        <div class="card shadow-sm">
            <div class="card-header">
                <h5 class="mb-0">Add Temperature</h5>
            </div>

            <div class="card-body">
                <form method="POST" action="{{ route('admin.temperatures.store') }}">
                    @csrf
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" name="min_temperature"
                            ...
                            value="{{ old('min_temperature') }}" placeholder="e.g. -10" required>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" name="max_temperature"
                            ...
                            value="{{ old('max_temperature') }}" placeholder="e.g. 0">
                        <small class="text-muted">Leave empty if no upper limit (e.g. +30°C)</small>
