                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-lg-6">
                                ...
                                <select name="material[]" class="form-select select2" multiple>
                                    @foreach ($materials as $material)
                                        <option value="{{ $material->id }}"
                                            {{ in_array($material->id, old('material', $product->material ?? [])) ? 'selected' : '' }}>
                                            {{ $material->material }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="number" name="temperature" value="{{ old('temperature', 0) }}"
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select name="intensity" class="form-select">
                                        <option value="low" {{ old('intensity') == 'low' ? 'selected' : '' }}>Low
                                        </option>
                                        <option value="high" {{ old('intensity') == 'high' ? 'selected' : '' }}>High
                                        </option>
                                    </select>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="number" name="insulation" value="{{ old('insulation', 0) }}"
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="number" name="breathability" value="{{ old('breathability', 0) }}"
                                        class="form-control" min="0" max="6">
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="mb-4">
                                ...
                                <div class="d-flex flex-wrap gap-2 mt-3" id="preview"></div>
                            </div>

                            <hr>

                            <div class="d-flex justify-content-between align-items-center mb-2">
                                <label class="form-label mb-0">Variant Produk</label>
                    ...
                    <div class="mt-4">
                        ...
                        @if ($categories->count() == 0)
                            <div class="alert alert-warning">
                                Harap buat kategori terlebih dahulu sebelum menambahkan produk.
                            </div>
...
@push('styles')
    <style>
        ...
        .select2-container--default.select2-container--focus .select2-selection--multiple {
            ...
            box-shadow: 0 0 0 0.2rem rgba(158, 128, 53, .25);
        }
