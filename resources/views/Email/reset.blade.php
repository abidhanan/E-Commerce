                    ...
                    <tr>
                        <td style="padding:28px 40px 32px 40px;">
                            ...
                            <p
                                ...
                                Kami menerima permintaan untuk mereset password akun Anda di <strong
                                    style="color:#1a1a1a;">{{ config('app.name') }}</strong>.<br>
                            ...
                            <p
                                style="font-family:'Poppins',Arial,sans-serif; letter-spacing:-0.05em; font-size:13px; color:#3a3a3a; line-height:1.75; margin:0 0 14px 0;">
                                Jika Anda tidak merasa melakukan permintaan ini, abaikan email ini.
                            </p>

                            <p
                                style="font-family:'Poppins',Arial,sans-serif; letter-spacing:-0.05em; font-size:13px; color:#3a3a3a; line-height:1.75; margin:0 0 28px 0;">
                                Link akan kedaluwarsa dalam <strong
                                    style="color:#1a1a1a;">{{ $expire ?? '60 menit' }}</strong>.
                            </p>
