<nav class="w-full bg-white border-b border-gray-200 sticky top-0 z-50">
    <div class="max-w-screen-2xl mx-auto px-6 py-2 flex justify-between items-center">
        ...
        <div class="flex-1 flex justify-end items-center space-x-2 text-xs font-bold uppercase">
            ...
            @auth
                <a href="{{ route('profile') }}" class="flex items-center space-x-2 px-5 py-2 rounded-full hover:bg-black hover:text-white transition-all duration-300">
                    <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                        <path d="M10 9a3 3 0 100-6 3 3 0 000 6zm-7 9a7 7 0 1114 0H3z"></path>
                    </svg>
   ...
   <div class="relative w-full border-t border-gray-100">
        <div class="flex justify-center space-x-12 py-4 text-xs font-bold uppercase tracking-widest">
            ...
            <div class="group static">
                <a href="#" class="pb-3 hover:text-[#c4a052] border-b-2 border-transparent group-hover:border-[#c4a052] transition cursor-pointer">Man</a>
                ...
                <div class="absolute left-0 top-full w-full bg-gradient-to-b from-[#fdfbf6] to-white shadow-2xl border-t border-gray-100 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 z-50">
                    ...
                    <div class="max-w-screen-lg mx-auto px-6 py-12 grid grid-cols-3 gap-8 text-center">
            ...
            <div class="group static">
                <a href="#" class="pb-3 hover:text-[#c4a052] border-b-2 border-transparent group-hover:border-[#c4a052] transition cursor-pointer">Women</a>
