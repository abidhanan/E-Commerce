            ...
            <div class="space-y-6">
                ...
                @empty
                    <div class="text-center py-16">
                        ...
                        <p class="text-gray-500 text-lg">Your wishlist is still empty.</p>
                        <a href="{{ route('shop.index') }}" class="inline-block mt-4 text-sm font-bold uppercase tracking-widest border-b border-black pb-1 hover:text-[#c4a052] transition">Explore Products</a>
                    </div>
                @endforelse
            </div>
