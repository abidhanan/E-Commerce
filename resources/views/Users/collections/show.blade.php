...
@section('content')
    <main class="listing-page">
        <section class="listing-hero">
            <span class="listing-eyebrow">Curated Collection</span>
            <h1 class="listing-title">{{ $collection->name }}</h1>
            <p class="listing-subtitle">
                Discover thoughtfully selected pieces crafted for style,
        ...
        <div class="listing-toolbar">
            <div>
                {{ number_format($products->total(), 0, ',', '.') }} items available
            </div>
        ...
        @if ($products->isNotEmpty())
            ...
            @if ($products->hasPages())
                <nav class="listing-pagination" aria-label="Collection pagination">
        ...
        @else
            <div class="listing-empty">
                This collection is currently being refreshed.
