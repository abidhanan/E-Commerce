<x-layouts.app>
    ...
    <section class="max-w-screen-xl mx-auto px-6 pb-20">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-1">
            @php
                // Ambil produk dari kategori pertama yang memiliki data produk untuk pengujian UI
                $sampleProducts = $categories->firstWhere(fn($cat) => $cat->products->count() > 0)?->products ?? collect();
            @endphp
            ...
            @empty
                <div class="col-span-full flex flex-col items-center justify-center py-12 text-gray-500">
                    <p>Bahkan kategori pun tidak memiliki produk.</p>
                </div>
            @endforelse
        </div>
    </section>
