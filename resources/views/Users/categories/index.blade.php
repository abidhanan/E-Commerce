<x-layouts.app>
    <div class="pb-20">
        ...
        <div class="relative w-full h-[40vh] md:h-[50vh] bg-gray-900 overflow-hidden">
            {{-- Mengambil gambar kategori dari database, dengan pelindung fallback unsplash jika gambar kosong --}}
            <img src="{{ $category->img ? asset('storage/' . $category->img) : 'https://images.unsplash.com/photo-1441984904996-e0b6ba687e04?auto=format&fit=crop&q=80&w=2000' }}" 
            ...
            <div class="absolute inset-0 flex flex-col items-center justify-center text-white text-center px-6">
                ...
                <p class="text-xs md:text-sm font-medium tracking-widest uppercase text-gray-300 max-w-2xl">
                    Browse our high-performance technical apparel optimized specifically for "{{ $category->name }}".
                </p>
            </div>
        </div>
        ...
        <div class="max-w-screen-xl mx-auto px-6 mt-12 flex justify-between items-center border-b border-gray-200 pb-4">
            <h2 class="text-xs font-bold uppercase tracking-widest text-gray-500">
                Showing <span class="text-black font-extrabold">{{ $products->total() }}</span> products in this category
            </h2>
            
            {{-- Form Sortir (Sediakan input agar siap menerima request saat Controller-mu sudah kamu perbaiki) --}}
        ...
        <div class="max-w-screen-xl mx-auto px-6 py-12">
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-x-8 gap-y-16">
                ...
                @forelse($products as $product)
                    @php
                        // Ekstraksi gambar utama dan harga varian termurah
                    ...
                    <div class="group flex flex-col">
                        <div class="relative w-full aspect-[3/4] bg-gray-100 overflow-hidden mb-4">
                            ...
                            {{-- KOMPONEN WISHLIST BUTTON (Independen & Langsung Diikat AJAX Global) --}}
                ...
                @empty
                    <div class="col-span-full flex flex-col items-center justify-center py-24 text-gray-400">
                        ...
                        <p class="text-sm uppercase tracking-widest font-bold">Kategori Kosong</p>
                        <p class="text-xs mt-2">Belum ada produk aktif yang dimasukkan ke dalam kategori ini.</p>
                    </div>
                @endforelse
