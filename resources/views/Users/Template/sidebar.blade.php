<div class="sidebar p-3" id="sidebar">
    ...
    <ul class="nav flex-column gap-2" style="list-style: none; padding-left: 0;">
        ...
        <li class="nav-item">
            ...
            {{ request()->routeIs('admin.products.*') || request()->routeIs('admin.categories.*') || request()->routeIs('admin.collections.*') ? '' : 'collapsed' }}"
            ...
            <div class="collapse 
            {{ request()->routeIs('admin.products.*') || request()->routeIs('admin.categories.*') || request()->routeIs('admin.collections.*') ? 'show' : '' }}"
                id="productMenu">
