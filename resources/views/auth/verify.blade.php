...
<body>
        ...
        <div class="form-section">
            <div class="form-container">
                ...
                <div class="form-heading">
                    ...
                    <p>Kamu harus memverifikasi email kamu terlebih dahulu. Silakan cek inbox atau folder spam untuk
                        menemukan email verifikasi.</p>
                </div>
                ...
                <form method="POST" action="{{ route('verification.send') }}" id="verify-form" data-disable-on-submit
                    data-loading-text="MENGIRIM EMAIL...">
                    @csrf
                ...
                <div class="form-footer">
                    Sudah terverifikasi?
                    <button type="button" onclick="goToLogin()">Kembali ke login</button>
                </div>
    ...
    <script>
        ...
        // Simpan slide state sebelum form submit agar halaman berikutnya bisa melanjutkan slider
