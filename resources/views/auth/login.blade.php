...
<body>
        ...
        <div class="form-section">
            <div class="form-container">
                ...
                <div class="toggle-buttons">
                    <button class="toggle-btn active" type="button">LOGIN</button>
                    <button class="toggle-btn" type="button" onclick="goToRegister()">CREATE ACCOUNT</button>
                </div>
                ...
                <form method="POST" action="{{ route('login') }}">
                    ...
                    <div style="text-align: left; margin-bottom: 14px;">
                        <button type="button" onclick="goToForgotPassword()"
                            style="background: none; border: none; color: #6b7280; font-size: 13px; cursor: pointer; padding: 0; text-decoration: none;">Forgot
                ...
                <div class="form-footer">
                    ...
                    <button type="button" onclick="goToRegister()">Create one</button>
                </div>
    ...
    <script>
        ...
        // Resume slide dari state terakhir (jika baru balik dari halaman register)
